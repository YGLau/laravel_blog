        ...
        <form action="{{ url('admin/article') }}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>缩略图：</th>
                    <td>
                        <input type="text" class="lg" name="art_thumb" style="max-width: 200px">
                ...
                <tr>
                    <th></th>
                    <td>
                        <img src="" id="upload_img" style="max-width: 200px; max-height: 100px;">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script id="editor" type="text/plain" name="art_content" style="width:880px;height:500px;"></script>
                        <script type="text/javascript">
                            //实例化编辑器
