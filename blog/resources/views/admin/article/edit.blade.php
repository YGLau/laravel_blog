    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{ url('admin/category/create') }}"><i class="fa fa-plus"></i>添加文章</a>
        ...
        <form action="{{ url('admin/article/'.$field->art_id) }}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>缩略图：</th>
                    <td>
                        <input type="text" class="lg" name="art_thumb" style="max-width: 200px" value="{{ $field->art_thumb }}">
                ...
                <tr>
                    <th></th>
                    <td>
                        <img src="/{{ $field->art_thumb }}" id="upload_img" style="max-width: 200px; max-height: 100px;">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script id="editor" type="text/plain" name="art_content" style="width:880px;height:500px;">{!! $field->art_content !!}</script>
                        <script type="text/javascript">
                            //实例化编辑器
