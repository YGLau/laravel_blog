	...
	<div class="menu_box">
		<ul>
			...
			<li>
				...
				<ul class="sub_menu">
					<li><a href="{{ url('admin/links') }}" target="main"><i class="fa fa-fw fa-share-alt-square"></i>友情链接</a></li>
					<li><a href="{{ url('admin/navs') }}" target="main"><i class="fa fa-fw fa-list-ul"></i>导航列表</a></li>
					<li><a href="{{ url('admin/navs/create') }}" target="main"><i class="fa fa-fw fa-edit"></i>添加导航</a></li>
					<li><a href="{{ url('admin/conf') }}" target="main"><i class="fa fa-fw fa-cogs"></i>网站配置</a></li>
				</ul>
			</li>
			{{--<li>--}}
